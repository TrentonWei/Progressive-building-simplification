...
namespace PrDispalce.PublicUtil
{
    class FeatureSym
    {
        ...
        #region Line symbolization
        public object LineSymbolization(int width, int LineRgbRed, int LineRgbGreen, int LineRgbBlue, esriSimpleLineStyle symbolstyle)
        {
            ESRI.ArcGIS.Display.ISimpleLineSymbol simpleLineSymbol = new ESRI.ArcGIS.Display.SimpleLineSymbolClass();
            simpleLineSymbol.Width = width;
