...
namespace PrDispalce.PublicUtil
{
    class FeatureHandle
    {
        ...
        #region Get IFeatureLayer by name
        ...
        #region data store in given field
        ...
        #region Create cache point layer 
        ...
        #region Create cache polyline layer
        ...
        #region Create cache polygon layer
